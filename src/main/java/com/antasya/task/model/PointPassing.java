package com.antasya.task.model;
...
/**
 * H_NOKTA_GECIS Tablosu.
 * Aracpc'lerden gonderilen durak gecis verisi icin kullanilan entity.
 * 
 * @author abdullah.dogan
 *
 */
@Entity
@Table(name="H_NOKTA_GECIS")
public class PointPassing extends BaseEntity{
	...
	private int stopTime; //Durakta durma-bekleme süresini tutar
	
	@Column(name="BINENYOLCUSAYISI")
	private int ridePassengerOrder; //Durakta binen yolcu sayisi
